...
public class Trinh_Phat_Nhac_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trinh__phat__nhac_2);
        AnhXa();
        btnPlay.setText("Pause");
        TenBH.setText(MainActivity.arraydsyt.get(MainActivity.i).getTenbh());
        DatGioHat();
        DatGioHet();
        ...
        btnPrev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity.i--;
                if(MainActivity.i < 0){
                    MainActivity.i = MainActivity.arraydsyt.size() - 1;
                }
                if(MainActivity.mdp.isPlaying()){
                    MainActivity.mdp.stop();
                }
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                btnPlay.setText("Pause");
                MainActivity.i++;
                if(MainActivity.i > MainActivity.arraydsyt.size() - 1){
                    MainActivity.i = 0;
                }
                if(MainActivity.mdp.isPlaying()){
                    MainActivity.mdp.stop();
    ...
    private void TaoBaiHat(){
        MainActivity.mdp = MediaPlayer.create(Trinh_Phat_Nhac_2.this, MainActivity.arraydsyt.get(MainActivity.i).getFile());
        TenBH.setText(MainActivity.arraydsyt.get(MainActivity.i).getTenbh());
    }
